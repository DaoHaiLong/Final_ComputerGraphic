...
Group5.Gui.MiniMap = function(width, height, parent) {
    this.parent = parent;
    this.width = width;
    this.height = height;
    this.blockSize = {
    ...
    this.create = function(top, left, position, border) {
        ...
        var styleTop = (top || "15") + "px;";
        var styleLeft = (left || "15") + "px;";
        var styleBorder = (border || "3px solid black") + ";";
    ...
    this.draw = function(x, y, id) {
        if (id == 1) {
            ...
            this.ctx.fillStyle = "rgb(193, 218, 214)";
        }
